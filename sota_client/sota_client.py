...
# configure logging
logFormatter = logging.Formatter("[%(asctime)s] - SOTACLIENT - %(levelname)s - %(message)s")
logger = logging.getLogger("SOTACLIENT")
logger.setLevel(logging.DEBUG)

fileHandler = logging.FileHandler("logs/{}.log".format("sota_client"))
